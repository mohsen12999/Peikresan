...
const ChangeableProductCount:(props:IChangeableProductCountProps)=>JSX.Element = ({
  id,
  count,
  max,
  soldByWeight,
...
const mapDispatchToProps = { AddProduct:actionCreators.addProduct, RemoveProduct:actionCreators.removeProduct };

export default connect(mapStateToProps, mapDispatchToProps)(ChangeableProductCount);
